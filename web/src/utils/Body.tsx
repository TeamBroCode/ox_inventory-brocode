    ...
    return (
        <div className="group">
            ...
            <div className="overlap-group" >
                ...
                <div onMouseEnter={() => { setHoverData(true); setBodypart('RHAND') }} onMouseLeave={() => { setHoverData(false) }} className='rarmmm' style={{ width: '2vw', height: '12vw', position: 'absolute', marginLeft: '17.2vw', marginTop: '7vw', zIndex: 1, borderRadius: '1vw', rotate: '-15deg' }} />
                <div onMouseEnter={() => { setHoverData(true); setBodypart('LHAND') }} onMouseLeave={() => { setHoverData(false) }} className='larmmm' style={{ width: '2vw', height: '12vw', position: 'absolute', marginLeft: '7vw', marginTop: '7.5vw', zIndex: 1, borderRadius: '1vw', rotate: '20deg' }} />
                ...
                <div onMouseEnter={() => { setHoverData(true); setBodypart('LARM') }} onMouseLeave={() => { setHoverData(false) }} className='lpalmmm' style={{ width: '2vw', height: '3vw', position: 'absolute', marginLeft: '3.8vw', marginTop: '18.5vw', zIndex: 1, borderRadius: '1vw', rotate: '20deg' }} />
                ...
                <div onMouseEnter={() => { setHoverData(true); setBodypart('RARM') }} onMouseLeave={() => { setHoverData(false) }} className='rpalmmm' style={{ width: '2vw', height: '4vw', position: 'absolute', marginLeft: '18.8vw', marginTop: '18.5vw', zIndex: 1, borderRadius: '1vw', rotate: '-10deg' }} />
                ...
                <Arrowright styles={{
                    ...
                    marginLeft: '15vw',
                    marginTop: '9vw',
                }} durablitystyles={{width:'5vw', marginLeft:'19.5vw', marginTop:'7.5vw', position:'absolute'}} label={'Right Hand'} percent={100-bodydamagecal["RHAND"]?.percent} />
                <Arrowright styles={{
                    width: '10vw',
                    height: '1.8vw',
                    position: 'absolute',
                ...
                <Arrowleft styles={{
                    ...
                    marginLeft: '1.2vw',
                    marginTop: '9vw',
                }} durablitystyles={{width:'5vw', marginLeft:'1.8vw', marginTop:'7.5vw', position:'absolute'}} label={'Right Hand'} percent={100-bodydamagecal["RHAND"]?.percent} />
                ...
                <img className="img" style={{ filter: `sepia(${bodydamagecal["RHAND"]?.percent}%) saturate(300%) brightness(100%) hue-rotate(299deg)` }} alt="Rhand" src={isEnvBrowser() ? irarm : getItemUrl('rarm')} />
                <img className="LARM" style={{ filter: `sepia(${bodydamagecal["LHAND"]?.percent}%) saturate(300%) brightness(100%) hue-rotate(299deg)` }} alt="Larm" src={isEnvBrowser() ? ilarm : getItemUrl('larm')} />
                <img className="img" style={{ filter: `sepia(${bodydamagecal["LARM"]?.percent}%) saturate(300%) brightness(100%) hue-rotate(299deg)` }} alt="Lparm" src={isEnvBrowser() ? ilpalm : getItemUrl('lpalm')} />
                ...
                <img className="RARM" style={{ filter: `sepia(${bodydamagecal["RARM"]?.percent}%) saturate(300%) brightness(100%) hue-rotate(299deg)` }} alt="Rarm" src={isEnvBrowser() ? irpalm : getItemUrl('rpalm')} />
